...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: RoutesEnums.POINTS,
        component: PointsComponent,
      },
      {
        path: RoutesEnums.USERS,
        component: UsersComponent,
      },
      {
        path: RoutesEnums.CONGREGATIONS,
      ...
      {
        path: RoutesEnums.STANDS,
        component: StandComponent,
      },
      {
        path: RoutesEnums.CALENDAR,
        component: CalendarComponent,
      },
            {
        path: RoutesEnums.SHIFT_REQUEST,
